...
<section>
  <form>
    ...
    <input type="text" id="name" name="name" placeholder="Schrijf hier je naam..">
    <label for="phone">Telefoon nummer:</label>
    <input type="text" id="phone" name="phone" placeholder="Schrijf hier je nummer.."   >
    <label for="email">Email:</label>
    <input type="text" id="email" name="email" placeholder="Schrijf hier je email.." >
    <label for="message">Bericht:</label>
    <textarea name="message" id="message" placeholder="Schrijf hier je bericht.." rows="10" cols="60"></textarea>
